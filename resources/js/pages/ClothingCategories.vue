...
function resetForm() {
    // Reset both data and validation state when switching between create/edit.
    form.defaults({ name: "" });
    form.reset();
    form.clearErrors();
...
function closeModal() {
    // Close + cleanup ensures stale form values do not leak to next open.
    modalOpen.value = false;
    resetForm();
}

function submit() {
    // Reuse one submit handler for create and update based on editingId.
    const options = {
        preserveScroll: true,
...
<template>
    ...
    <main class="h-screen overflow-hidden bg-slate-100 text-slate-900">
        ...
        <!-- Reusable modal for creating and editing category records. -->
        <AppModal
            :open="modalOpen"
            :title="title"
            :subtitle="subtitle"
        ...
        <div class="grid h-full lg:grid-cols-[260px_minmax(0,1fr)]">
            ...
            <div class="min-w-0 overflow-y-auto">
                ...
                <div class="px-4 py-6 sm:px-6 lg:px-8">
                    <!-- Summary cards for category counts shown at the top of the page. -->
                    ...
                    <!-- Main content area with search, add button, and category listing. -->
                    <section class="glass-panel mt-6 p-5 sm:p-6">
                        ...
                        >
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Add categories like Barong, Filipiniana,
                                    Gown, or Uniform and keep naming consistent.
                                </p>
                            </div>
                        ...
                        <!-- Data table shown when at least one category exists. -->
                        <div
                        ...
                        >
                            ...
                            >
                                <template #cell-name="{ item }">
                                    <p
                                        class="font-semibold text-slate-900 text-left"
                                    >
                                        {{ item.name }}
                                    </p>
                                </template>
                        ...
                        <!-- Empty state shown when the category list has no results. -->
                        <div
                            v-else
                        ...
                        >
                            ...
                            <p class="mt-2 text-sm text-slate-500">
                                Create your first clothing category such as
                                Barong or Filipiniana.
                            </p>
                        </div>
                    </section>
                </div>
